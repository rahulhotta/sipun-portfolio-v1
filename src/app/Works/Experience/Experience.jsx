...
const company = [
  ...
  },
  {
    ...
    skillsInvolved: [
      ...
      "Mentoring team",
      "Release planning",
      "Test Stratergies and Coverages",
      "Testing RPA",
    ],
  },
  {
  ...
  },
  {
    ...
    role: "Senior SDET",
    skillsInvolved: [
      "Automating Beats webapp",
      "Testing using AEM",
      "Verifying AEM tool",
      "Validating wireframe",
    ],
  },
  {
        ...
        return (
          <div className={styles.experience__card} key={company.name}>
            <div className={styles.experience__card_left}>
              <h2 className={styles.experience__card_name}>{company.name}</h2>
              <p className={styles.experience__card_duration}>
                {company.duration}
              </p>
            </div>
            <div className={styles.experience__card_right}>
              <p className={styles.experience__card_role}>{company.role}</p>
